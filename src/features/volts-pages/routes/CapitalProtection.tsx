...
import { Volt5OutcomesChartInCard } from "../components/Volt5OutcomesChartInCard";
import { InlineHoverDoc } from "09/misc09";
...
export const CapitalProtection = () => {
  ...
  const [_, colorB] = getVoltColorPair(5);
  ...
  return (
    <>
      ...
      <VoltInformation>
        <StrategyContainer>
          <StrategyDescription>
            Volt #05 uses interest revenue from lending to hedge against SOL
            price falling drastically. As a result, you get{" "}
            <InlineHoverDoc
              content={
                "Principal protection: only interest earned is used to hedge, principal is subject to overcollateralized lending platform risks"
              }
            >
              100% principal protection
            </InlineHoverDoc>{" "}
            and long volatility in a single powerful product.{" "}
            <a
        ...
        <InfoCardsContainer>
          <PerformanceCard
            ...
            cards={cards}
          >
            Best in volatile markets with rising interest rates.
          </PerformanceCard>
          <RiskCard voltNumber={5}>
            Principal protection - Deposit value is{" "}
            <InlineHoverDoc
              content={
                "Principal protection: only interest earned is used to hedge, principal is subject to overcollateralized lending platform risks"
              }
            ...
            <br />
            Price hedge - Generate outsized returns if SOL price falls{" "}
            <b>more than 25%</b>
          </RiskCard>
        </InfoCardsContainer>
      </VoltInformation>
