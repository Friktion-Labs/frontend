...
import { StablesChart } from "../components/StablesChart";
...
export const Stables = () => {
  ...
  const [_, colorB] = getVoltColorPair(2);
  ...
  return (
    <>
      {/* <Header voltNumber={2}>Sustainable Stables</Header> */}
      <ZeroNineManagementModal modalSesameBall={modalSesameBall} />
      <VoltInformation>
        <StrategyContainer>
          <StrategyDescription>
            Volt #02 generates returns on stablecoin deposits by running an
            automated cash secured put strategy. Deposits are deployed into the
            upcoming Epoch and earnings are auto-compounded weekly.{" "}
            <a
              href="https://docs.friktion.fi/products/volt-02-sustainable-stables"
              target="_blank"
              rel="noreferrer"
              css={css`
                gap: 2px;
        ...
        <InfoCardsContainer>
          <PerformanceCard
            ...
            cards={cards}
          >
            Best in bull to moderately bearish markets (rising prices lowering
            chance of options being exercised)
          </PerformanceCard>
          <RiskCard voltNumber={2}>
            If the price of the underlying asset goes below the put option’s
